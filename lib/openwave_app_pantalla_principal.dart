        ...
        children: [
          ...
          Consumer<Reproductor>(
              builder: (context, manager, child) {
                ...
                return Material(
                  elevation: 8, // Añade una pequeña sombra para separarlo del contenido
                  color: Theme.of(context).bottomAppBarTheme.color ?? Theme.of(context).colorScheme.surfaceContainer,
                  child: InkWell(
                      child: Padding(
